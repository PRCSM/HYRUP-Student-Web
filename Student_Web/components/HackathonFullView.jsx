            ...
            <div className='w-screen ml-9 mt-20 ml-35'>
              ...
              <div className='flex flex-row m-8 justify-between'>
                <div className='flex flex-row gap-x-12'>
                  <button className='text-[17px] h-[50px] cursor-pointer border-2 px-6 py-2 rounded-md font-medium font-[Jost] bg-[#E3FEAA]'>Featured</button>
...
export default HackathonFullView