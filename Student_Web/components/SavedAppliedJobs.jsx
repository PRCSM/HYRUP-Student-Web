...
export const LeftNavBar = () => {
  return(
    <>
    <div className='bg-red-500 w-20 h-screen relative'></div>
    </>
  )
}
export const TopNavBar = () => {
  return(
    <>
    <div className='bg-blue-500 w-screen h-20 relative'></div>
    </>
  )
}
export const Card = ({typeOf}) => {
  return(
    <> 
    <Link to={typeOf}>
      <div className=' w-[438px] h-[363px] bg-white flex flex-col border-3 items-start font-[Jost] py-4 rounded-2xl shadow-[5px_5px_0px_0px_rgba(0,0,0,1)]'>
        <div className='bg-blue-900 w-[90%] h-full mx-auto rounded-2xl'></div>
        <div className='flex flex-row mt-3'>
          <div className='flex flex-col ml-6'>
            <div className='text-[35px] font-[600]'>UI/UX Designer</div>
            <div className='flex flex-row justify-between items-center'>
              <div className='font-regular text-[24px]'>Lumel Technologies</div>
              <div>
          ...
          <div className='flex flex-col ml-6'>
            ...
            <div className='border-2 px-7 py-1 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] rounded-4xl font-regular text-[12px] m-1 text-center'>E-COMMERCE</div>
          </div>
        </div>
