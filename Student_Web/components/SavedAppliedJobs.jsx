...
export const Card1 = ({typeOf,result}) => {
  return(
    <> 
    <Link to={typeOf}>
      <div className=' w-[full] h-[full] bg-white flex flex-col border-3 items-start font-[Jost] py-4 rounded-2xl shadow-[5px_5px_0px_0px_rgba(0,0,0,1)]'>
        ...
        <div className='flex flex-row mt-3 justify-between'>
          ...
          <div className='flex flex-col ml-6 mr-3'>
            <div className='border-2 px-7 py-1 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] rounded-4xl font-regular text-[12px] m-1 text-center whitespace-nowrap'>{result}</div>
          </div>
        </div>
      ...
      <div className='flex flex-row'>
        <div className='flex-1'>
          ...
          <div className='flex flex-row px-9 gap-x-14 relative px-10'>
            ...
            <Card1 typeOf={"/appliedjobcard"} result={"Applied"}/>
            <Card1 typeOf={"/appliedjobcard"} result={"Shortlisted"}/>
            <Card1 typeOf={"/appliedjobcard"} result={"Rejected"}/>
